...
// Check if AES key starts with unwanted strings (235711, "ayushi", "12400267")
bool isWeakKey(const string& key) {
    return key.rfind("235711", 0) == 0 || key.rfind("ayushi", 0) == 0 || key.rfind("12400267", 0) == 0;
}
...
int main() {
    ...
    if (isWeakKey(aesKey)) {
        cout << "Weak AES key. Do not start with '235711', 'ayushi', or '12400267'." << endl;
        return 1;
    }
